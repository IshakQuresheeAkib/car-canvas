...
const Footer = () => {
  ...
  <nav>
    <header className="font-bold text-lg text-white/60">Services</header> 
  ...
  <nav>
    <header className="font-bold text-lg text-white/60">Company</header> 
  ...
  <nav>
    <header className="font-bold text-lg text-white/60">Legal</header> 
    ...
    <a className="link link-hover">Cookie policy</a>
            ...
            <aside className="items-center grid-flow-col">
                ...
                <p>Car Canvas. <br/>Providing reliable service since 1992</p>
            </aside> 
